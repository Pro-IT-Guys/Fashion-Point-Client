...
export default function AllOrders() {
  ...
  useEffect(() => {
    fetch(
      `https://fashion-point-server.vercel.app/api/v1/order?searchTerm=${filterName}&page=${page}&limit=${rowsPerPage}`
    )
      .then(res => res.json())
  ...
  const handleUpdateOrder = (id, status) => {
    fetch(`https://fashion-point-server.vercel.app/api/v1/order/${id}`, {
      method: 'PATCH',
      headers: {
